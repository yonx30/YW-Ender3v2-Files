...
#define CUSTOM_MACHINE_NAME "YW Ender-3 V2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.7, 80.0, 409.8, 714.5 } // Actual default is { 80, 80, 400, 93 }, this is my own calibrateed one
// Was 81.7, 82.0, 409.2, 700.3 
...
#define Z_PROBE_FEEDRATE_FAST (3*75)
...
//#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 20, 30, 0, 47.5 } // (mm) Left, Front, Right, Back insets
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60) } // Reduces speed of homing 
...
#define PREHEAT_4_LABEL       "Prep"
#define PREHEAT_4_TEMP_HOTEND 140
